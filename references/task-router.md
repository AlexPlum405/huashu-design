...
| 生产级桌面 App、Sequoia、Fluent、Windows 11 原型 | Production Desktop Prototype | `references/macos-apps.md` + `references/windows-apps.md` + `references/react-setup.md` | Apple HIG, Microsoft Fluent, Mobbin (Desktop) | `assets/desktop_design_system.jsx` + `scripts/design_lint.py` + `scripts/verify.py` | - | Platform specific architecture (Sidebar/Toolbar) confirmed + native materials (Mica/Glass) applied |
